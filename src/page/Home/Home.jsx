...
import PlanComponents from "./component/PlanComponents"
import CardComponets from "./component/CardComponents"
...
/>
    ...
    {
        owner && owner._id ?(
            <Avatar className = "cursor-pointer shadow-black  bg-black" >
            <AvatarImage  src="https://avatars.githubusercontent.com/u/162489688?s=48&v=4" onClick={()=> navigate("/menu")} />

...
const Plans = () => {
  ...
  const RegularCheckoutHandler = async() =>{
    console.log("Hello");
    // api call
    ...
    const {data:{subscriptionId}} = await axios.post(`${url}/createSubscription`,{
      plan_id:regularKey
    },{
  ...
  // };
      ...
      const options = {
        ...
        prefill:{
          ...
          email: owner.owner_email,
          contact: owner.owner_phoneNumber,
        },
        notes:{
          address: "DASH"
        },
  ...
  return (
    <div className='w-screen h-screen bg-black flex justify-center flex-col items-center gap-5'>
      ...
      <div className='w-full flex gap-11 justify-center'>
        <PlanComponents planType='REGULAR' planAmount='599' planFeatures={PlanFeatures.regular} checkoutHandler={RegularCheckoutHandler} />
